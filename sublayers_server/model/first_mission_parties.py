            ...
            roles=[
                Role('Cargo',
                    car_params=dict(
                        ...
                        weapons=[
                            dict(direction=pi, sector_width=70, r=200, damage=10, is_auto=False),
                            dict(direction=pi/2, sector_width=70, r=150, damage=10, is_auto=False),
                            dict(direction=-pi/2, sector_width=70, r=150, damage=10, is_auto=False),
                        ],
                     ),
                     max_count=1,
                ...
                Role('Rover',
                    car_params=dict(
                        ...
                        weapons=[
                            dict(direction=0, sector_width=50, r=350, damage=10, is_auto=False),
                            dict(direction=pi/2, sector_width=50, r=300, damage=10, is_auto=False),
                            dict(direction=-pi/2, sector_width=50, r=300, damage=10, is_auto=False),
                        ],
                     ),
                     weight=1,
                ...
                Role('Scout',
                    car_params=dict(
                        ...
                        weapons=[
                            dict(direction=0, sector_width=40, r=400, damage=6, is_auto=False),
                        ],
                     ),
                     weight=1,
                ),
                Role('Tank',
                    car_params=dict(
                        ...
                        weapons=[
                            dict(direction=0, sector_width=80, r=200, damage=18, is_auto=False),
                            dict(direction=pi, sector_width=80, r=150, damage=12, is_auto=False),
                            dict(direction=pi/2, sector_width=80, r=150, damage=12, is_auto=False),
                            dict(direction=-pi/2, sector_width=80, r=150, damage=12, is_auto=False),
                        ],
                     ),
                     weight=1,
