...
function onKeyDownMap(event) {
    ...
    switch (event.keyCode) {
        ...
        case 90:  // Z
            ...
            */
            new WAutoFireOnShooter(user.userCar, 'front');
            setTimeout(function(){new WAutoFireOnShooter(user.userCar, 'left');}, 500);
            setTimeout(function(){new WAutoFireOnShooter(user.userCar, 'right');}, 800);
            setTimeout(function(){new WAutoFireOnShooter(user.userCar, 'back');}, 2864);
