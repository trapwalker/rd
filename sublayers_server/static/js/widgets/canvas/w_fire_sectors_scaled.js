...
var WCanvasFireSectorsScaled = (function (_super) {
    ...
    WCanvasFireSectorsScaled.prototype.init_marker = function(t){
    ...
    WCanvasFireSectorsScaled.prototype._init_svg_parametrs = function () {
        var g = this.main_g;
    ...
    WCanvasFireSectorsScaled.prototype._drawSectors = function(ctx, zoom_koeff, time){
        ...
        if (max_disch_radius > second_radius && max_disch_width > 0) {
            side_elem = this._drawOneSide(ctx, second_radius / zoom_koeff, max_disch_radius / zoom_koeff, max_disch_width, 0.0);
        }
        ...
        if (max_disch_radius > second_radius && max_disch_width > 0) {
            side_elem = this._drawOneSide(ctx, second_radius / zoom_koeff, max_disch_radius/ zoom_koeff, max_disch_width, -Math.PI);
            side_obj = {
                g: side_elem,
        ...
        if (max_disch_radius > second_radius && max_disch_width > 0) {
            side_elem = this._drawOneSide(ctx, second_radius / zoom_koeff, max_disch_radius/ zoom_koeff, max_disch_width, -Math.PI / 2.);
            side_obj = {
                g: side_elem,
                radius: max_disch_radius,
                visible: true
    ...
    WCanvasFireSectorsScaled.prototype._drawOneSector = function(ctx, minRadius, maxRadius, width, direction){
        ...
        //grad_stroke.addColorStop(0.3, "rgba(85, 255, 85, 0.9)");
    ...
    WCanvasFireSectorsScaled.prototype._drawOneSide = function(ctx, minRadius, maxRadius, width, direction){
        ...
        ctx.strokeStyle = grad_stroke_arc;

        ctx.beginPath();
        ctx.arc(0, 0, maxRadius, -width / 2, -width / 2 + Math.PI / 25, false);
        ctx.stroke();

        ctx.beginPath();
        ctx.arc(0, 0, maxRadius, width / 2, width / 2 - Math.PI / 25, true);
        ctx.stroke();
    ...
    WCanvasFireSectorsScaled.prototype._drawZoomatorsText = function(){
    ...
    WCanvasFireSectorsScaled.prototype._drawZoomatorsText2 = function(){
    ...
    WCanvasFireSectorsScaled.prototype._drawRechargeArea = function(side_str){
    ...
    WCanvasFireSectorsScaled.prototype._recharging = function(options){
    ...
    WCanvasFireSectorsScaled.prototype.setZoom = function(new_zoom){
    ...
    WCanvasFireSectorsScaled.prototype.rotate = function(angle_in_degrees){
    ...
    WCanvasFireSectorsScaled.prototype.redraw = function(ctx, time){
        //console.log('WFireRadialGrid.prototype.redraw');
        ctx.save();
