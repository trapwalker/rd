...
formatter_simple = Formatter('%(relativeCreated)08d %(levelname)-7s %(message)s')
formatter_simple_for_agent = Formatter('%(asctime)s %(levelname)-7s %(message)s')
formatter_complex = Formatter('%(asctime)s %(levelname)-7s [%(filename)21s:%(lineno)-4d] %(message)s')
formatter_websrv = Formatter('%(asctime)s %(levelname)-7s %(message)s')
formatter_events = Formatter('%(asctime)s %(levelname)-7s %(message)s')
formatter_stat = Formatter('%(message)s')
