...
var CanvasNoise = (function(){
    function CanvasNoise() {
        ...
        var image_array = [
            'static/error/50x/img/noise/n_noise_001.png',
            'static/error/50x/img/noise/n_noise_002.png',
            'static/error/50x/img/noise/n_noise_003.png',
            'static/error/50x/img/noise/n_noise_004.png',
            'static/error/50x/img/noise/n_noise_005.png'
        ];
        var self = this;
