            ...
            defaults = {
                ...
                tileproviders: [
                    // Слои карты. Отрисовка начинается с нулевого слоя. Здесь очень важен порядок!
                    {
                        name: "back",
                        url: function (x, y, z) {
                            return "roaddogs.ru/map/back/" + z + "/" + x + "/" + y + ".png";
                        },
                        alpha: 1.0,
                        visible: true,
                        with_arc_404: true,
                    },
                    {
                        name: "front",
                        url: function (x, y, z) {
                            return "roaddogs.ru/map/front/" + z + "/" + x + "/" + y + ".png";
                        },
                        alpha: 1.0,
                        visible: true,
                        with_arc_404: false,
                    },
                    {
                        name: "merged",
                        url: function (x, y, z) {
                            return "roaddogs.ru/map/merged/" + z + "/" + x + "/" + y + ".png";
                        },
                        alpha: 1.0,
                        visible: true,
                        with_arc_404: false,
                    ...
                    //        };
                    //        sub = ["a", "b", "c"];
                    //        url = sub[rand(3)] + ".tile.openstreetmap.org/" + z + "/" + x + "/" + y + ".png";
                    //        return url;
                    //    },
                    //    alpha: 0.5,
                    //    visible: true,
